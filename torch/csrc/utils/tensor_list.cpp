...
// returns python object matching item(), constant int/float or symint/symfloat/symbool depending on input
// non constant data will return unbacked symint if allow_scalar_outputs else raise error
